...
public class AppInitializer {
    ...
    private String CREATE_TABLE_STATUS = "CREATE TABLE status (id INT AUTO_INCREMENT, status VARCHAR(10), PRIMARY KEY(id));\n";
    private String CREATE_TABLE_VEHICLE = "CREATE TABLE vehicles (id INT AUTO_INCREMENT, brand VARCHAR(30), model VARCHAR(30), year INT(4), registration VARCHAR(10), inspection DATE, customer_id INT, PRIMARY KEY(id), FOREIGN KEY(customer_id) REFERENCES customers(id));";
